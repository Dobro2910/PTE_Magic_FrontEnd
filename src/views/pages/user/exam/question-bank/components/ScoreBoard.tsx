...
@withScoreInfoModal()
class ScoreBoard extends Component<any, any> {
  ...
  filterData = async (page = 1, pageSize = 5) => {
    ...
    let res = await axios.post('api/account/search-exam-history-all-user', { page, pageSize, data : { param1: this.props.questionId }});
  ...
  render() {
    ...
    return (
      <>
        <Card>
          <CardHeader>
            <h3 className="mb-0">Score Board</h3>
          </CardHeader>
          { loading ? 
            <Card>
              <CardHeader>
