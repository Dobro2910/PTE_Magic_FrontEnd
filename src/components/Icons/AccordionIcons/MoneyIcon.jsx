...
export default function MoneyIcon() {
    return (
        <>
            ...
            >
                <path
                    d="M0 2.7C0 1.2 1.2 0 2.7 0h18.6C22.8 0 24 1.2 24 2.7v18.6c0 1.5-1.2 2.7-2.7 2.7H2.7A2.7 2.7 0 010 21.3V2.7z"
                    fill="#FFD000"
                >
                </path>
                <path
                    d="M7 12.6v-.2h2.6v.2c0 .9.8 1.5 2.1 1.5s2.1-.5 2.1-1.4c0-.5-.2-.8-.9-1L9.7 11c-1.6-.4-2.5-1.2-2.5-2.8C7.2 6 9 4.7 11.6 4.7c2.6 0 4.3 1.3 4.3 3.5v.1h-2.5v-.2c0-.8-.5-1.4-1.8-1.4-1.1 0-1.8.5-1.8 1.2 0 .6.3.8.8 1l3.3.8c1.6.4 2.5 1.3 2.5 2.8 0 2-2 3.6-4.7 3.6S7 14.9 7 12.6z"
                    fill="#1B1B20"
                >
